<template>
  <svg
    ...
    viewBox="0 0 371.08 371.08"
    xml:space="preserve"
  >
    <g>
      <path
        d="M370.235,198.554l-45.454-80.227V71.693c0-3.59-2.91-6.5-6.5-6.5h-22.793L280.52,43.585
      ...
      />
      <path
        d="M123.05,178.074l-19.903-6.634c-0.213-2.972-1.926-7.107-8.387-11.075c-4.711-2.893-11.144-5.204-18.113-6.505
